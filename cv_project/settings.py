...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-cv-website-secret-key-replace-in-production')
...
# Expected format: postgres://USERNAME:PASSWORD@HOST:PORT/DATABASE_NAME
db_parts = DATABASE_URL.split('://')[-1].split('@')
db_credentials = db_parts[0].split(':')
db_location = db_parts[1].split('/')
db_host_port = db_location[0].split(':')
